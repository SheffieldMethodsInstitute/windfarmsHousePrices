...
public class DataInput {
     ...
     * @throws Exception
     */
    public static DataStore loadData(String filename, String pointType, int xFieldIndex, int yFieldIndex, int heightIndex) throws Exception {
...
//                    System.out.println("heightIndex: " + heightIndex + ", col: " + (int) Float.parseFloat(cells[heightIndex]));
                ...
                data.points.add(DataStore.createPoint(pointType, line, x, y, Main.raster[x][y], height));
