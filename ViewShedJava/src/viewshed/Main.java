...
//        File[] listOfFiles = folder.listFiles();
        ...
        if (true) {
            ...
            for (int fileIndex = batchNumber; fileIndex < list.size() + 1; fileIndex++) {
                ...
                //serialise at intervals in case we stop running for any reason and can pick up where we left off
...
//                heights = BresenhamLine.findLine(observerX, observerY, (int) target.x, (int) target.y);
                ...
                //In this case from target to observer
                //if building height run, vanilla DEM will be in index 1.
