...
/********************
Dan Olner: I've hacked this so that the Viewshed function takes the raster and vector
objects directly rather than from their map layer names / IDs
So they don't need to be added to the layer registry first.
They're all marked with #DANHACK
"""
    ...
    def visibility(x0, y0, target_list, options,
        ...
        for n in target_list:
            ...
            if options == "Intervisibility" :# individual settings for each target point
                #print("Intervisibility option detected")
...
# -------------- MAIN ----------------------------
    ...
    RasterPath= str(Raster_layer.dataProvider().dataSourceUri())
